...
function removeRepost(data) {
	...
	console.log('removeRepost success');
	return data;
}
...
function removeMain(data) {
	...
	data.items = newItems;
	console.log('removeMain success');
	return data;
}

function topicHandler(data) {
	console.log('topicHandler start');
	...
	data.items = newItems;
	console.log('topicHandler success');
	return data;
}
...
function removeSearchMain(data) {
	...
	console.log('remove_search main success');
	return data;
}
...
function removeSearch(data) {
	...
	data.items = newItems;
	console.log('remove_search success');
	return data;
}
...
function updateFollowOrder(item) {
	try {
		...
		console.console.log('updateFollowOrder fail');
	}
}
...
function updateProfileSkin(item, k) {
	try {
		...
		console.console.log('updateProfileSkin fail');
	}
}
...
function userHandler(data) {
	...
	data.items = newItems;
	console.log('removeMain sub success');
	return data;
}
...
function nextVideoHandler(data) {
	if (mainConfig.removeNextVideo) {
		data.statuses = [];
		data.tab_list = [];
		console.console.log('nextVideoHandler');
	}
}
